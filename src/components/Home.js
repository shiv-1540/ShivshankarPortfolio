...
function Home() {
  return (
    <div id="home" className="min-h-screen pt-16 bg-gray-900 text-white flex flex-col items-center">
      <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center">
        <div className="intro text-center md:text-left mb-8 mt-5 md:mb-0 flex-1">
        ...
        <div className="box flex-shrink-0 md:ml-10 mt-8 md:mt-0">
          <img
            ...
            alt="Shivshankar"
            width="270px"
            className="photo rounded-full shadow-lg border-4 border-red-500 transition-transform duration-300 transform hover:scale-110"
          />
        </div>
      </div>
    </div>
