...
function Projects() {
  return (
    <div id="projects" className="min-h-screen py-16 bg-gray-100 text-gray-800">
      ...
      <div className="cards grid grid-cols-1 sm:ml-8 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
        <div
          className="card bg-white  ml-10 shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out animate-fadeInUp"
          id="farm"
        >
        ...
        <div
          className="card bg-white shadow-lg  ml-10 rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out animate-fadeInUp"
          id="civil"
        >
        ...
        <div
          className="card bg-white shadow-lg rounded-lg  ml-10 overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out animate-fadeInUp"
          id="email_detect"
        >
